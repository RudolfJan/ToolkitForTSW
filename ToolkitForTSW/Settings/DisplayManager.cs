...
namespace ToolkitForTSW.Settings
  ...
  static class DisplayManager
    ...
    /// </remarks>
    public static IEnumerable<DisplaySettings> GetDisplayModes()
      {
    ...
    public static void RotateScreen(bool clockwise)
      ...
      (set.Width, set.Height) = (set.Height, set.Width);
      if (clockwise)
        set.Orientation++;
      else
        set.Orientation--;
    ...
    private static string GetLastError()
      ...
      if (SafeNativeMethods.FormatMessage(SafeNativeMethods.FORMAT_MESSAGE_FLAGS, SafeNativeMethods.FORMAT_MESSAGE_FROM_HMODULE, (uint)err, 0, out string msg, 0, 0) == 0)
